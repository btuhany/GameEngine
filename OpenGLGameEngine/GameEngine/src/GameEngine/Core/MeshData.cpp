...
namespace GameEngine {
	...
	void MeshData::CreateMesh(GLfloat* vertices, unsigned int* indices, unsigned int numOfVertices, unsigned int numOfIndices)
	{
	...
	GLuint MeshData::GetIBO()
	{
		return m_IBO;
	}

	GLuint MeshData::GetIndexCount()
	{
		return m_IndexCount;
	}
}